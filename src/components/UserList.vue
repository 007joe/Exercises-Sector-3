...
export default {
  ...
  computed: {
  filteredList() {
    return this.users.filter(filteredUser =>  filteredUser.firstName.toUpperCase().includes(this.filter.firstName.toUpperCase()) &&
       filteredUser.lastName.toUpperCase().includes(this.filter.lastName.toUpperCase()) && 
       filteredUser.username.toUpperCase().includes(this.filter.username.toUpperCase()) &&
       filteredUser.emailAddress.toUpperCase().includes(this.filter.emailAddress.toUpperCase()) &&
      filteredUser.status.toUpperCase().includes(this.filter.status.toUpperCase()))
  }

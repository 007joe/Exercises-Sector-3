  ...
  <div class="container">
    <table id="tblUsers">
      ...
      <tbody>
        ...
        >
          <td>
            <input type="checkbox" v-bind:id="user.id" v-bind:value="selectedUserIDs.includes(user.id)" />
          </td>
    ...
    <button v-on:click.prevent="showForm ? showForm=false:showForm=true">Add New User</button>
...
export default {
  ...
  methods: {
    ...
    this.users.forEach((userId) => {
      if (id == userId.id) {
        userId.status === "Active" ? userId.status = "Disabled" : userId.status = "Active";
      }
    })
    },
    enableSelectedUsers() {
